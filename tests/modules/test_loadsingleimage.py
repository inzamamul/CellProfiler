...
"""
    ...
    def test_03_04_object_measurement_columns(self):
        ...
        expected_columns = (
            ...
            (cellprofiler.measurement.IMAGE, cellprofiler.measurement.region.C_COUNT + "_" + OBJECTS_NAME),
            (OBJECTS_NAME, cellprofiler.measurement.region.C_LOCATION + "_" + cellprofiler.measurement.region.FTR_CENTER_X),
            (OBJECTS_NAME, cellprofiler.measurement.region.C_LOCATION + "_" + cellprofiler.measurement.region.FTR_CENTER_Y),
            (OBJECTS_NAME, cellprofiler.measurement.region.C_NUMBER + "_" + cellprofiler.measurement.region.FTR_OBJECT_NUMBER))
    ...
    def test_03_05_object_categories(self):
        ...
        for object_name, expected_categories in (
                (cellprofiler.measurement.IMAGE, (cellprofiler.measurement.region.C_COUNT, cellprofiler.modules.loadsingleimage.C_OBJECTS_FILE_NAME, cellprofiler.modules.loadsingleimage.C_OBJECTS_PATH_NAME)),
                (OBJECTS_NAME, (cellprofiler.measurement.region.C_NUMBER, cellprofiler.measurement.region.C_LOCATION))):
    ...
    def test_03_06_object_measurements(self):
        ...
        for object_name, category, expected_features in (
                (cellprofiler.measurement.IMAGE, cellprofiler.measurement.region.C_COUNT, (OBJECTS_NAME,)),
                ...
                (OBJECTS_NAME, cellprofiler.measurement.region.C_NUMBER, (
                cellprofiler.measurement.region.FTR_OBJECT_NUMBER,)),
                (OBJECTS_NAME, cellprofiler.measurement.region.C_LOCATION, (
                cellprofiler.measurement.region.FTR_CENTER_X, cellprofiler.measurement.region.FTR_CENTER_Y))):
    ...
    def test_04_01_load_objects(self):
        ...
        try:
            ...
            self.assertEqual(m.get_current_image_measurement(
                    "_".join((cellprofiler.measurement.region.C_COUNT, OBJECTS_NAME))), 9)
            self.assertEqual(m.get_current_image_measurement(
            ...
            cellprofiler.measurement.region.M_NUMBER_OBJECT_NUMBER):
