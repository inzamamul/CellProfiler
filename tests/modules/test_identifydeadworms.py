...
'''
    ...
    def test_02_01_zeros(self):
        ...
        count = workspace.measurements.get_current_image_measurement(
                '_'.join((cellprofiler.measurement.region.C_COUNT, OBJECTS_NAME)))
    ...
    def test_03_01_measurement_columns(self):
        ...
        expected = (
            (OBJECTS_NAME, cellprofiler.measurement.region.M_LOCATION_CENTER_X, cpmeas.COLTYPE_INTEGER),
            (OBJECTS_NAME, cellprofiler.measurement.region.M_LOCATION_CENTER_Y, cpmeas.COLTYPE_INTEGER),
            (OBJECTS_NAME, ID.M_ANGLE, cpmeas.COLTYPE_FLOAT),
            (OBJECTS_NAME, cellprofiler.measurement.region.M_NUMBER_OBJECT_NUMBER, cpmeas.COLTYPE_INTEGER),
            (cpmeas.IMAGE, cellprofiler.measurement.region.FF_COUNT % OBJECTS_NAME, cpmeas.COLTYPE_INTEGER))
